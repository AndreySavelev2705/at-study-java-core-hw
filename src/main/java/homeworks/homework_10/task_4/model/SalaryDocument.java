...
import homeworks.homework_10.task_4.helpers.DocumentQueue;
import homeworks.homework_10.task_4.helpers.DoubleHelper;
...
public class SalaryDocument implements Generatable, Save {
    ...
    public SalaryDocument generate() {
        for (int i = 0; i < Property.SALARY_EMPLOYEE_COUNT; i++) {
            Employee newEmployee = (Employee) new Employee().generate();
