...
public class Application {
    public static void main(String[] args) throws IOException {
        File inputFile = new File("src/main/java/homeworks/homework_10/task_1/input.txt");
        File outputFile = new File("src/main/java/homeworks/homework_10/task_1/output.txt");
