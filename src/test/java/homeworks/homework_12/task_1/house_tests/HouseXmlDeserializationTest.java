...
public class HouseXmlDeserializationTest {
    @Test
    @DisplayName("Дисериализация дома из Json файла")
    public void deserializationFromJsonHouseTest() {
        String pathToFile = "src/test/java/homeworks/homework_12/task_1/house_tests/house.xml";
        String data;
        ...
        House house = (House) new XmlHelper().deserialize(data, House.class);
