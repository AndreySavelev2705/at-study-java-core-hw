package homeworks.homework_11.tsask_4;

import homeworks.homework_11.task_4.Passport;
import homeworks.homework_11.task_4.Person;
import homeworks.homework_11.task_4.helpers.FileHelper;
...
public class PersonExcelFileTest {
    ...
    public void getPersonsFromSheetOfExcelFileTest() {
        String fileLocation = "src/main/java/homeworks/homework_11/task_4/persons.xlsx";
    ...
    public void getPersonsFromSheetOfUnknownExcelFileTest() {
        String fileLocation = "src/main/java/homeworks/homework_11/task_4/personsN/A.xlsx";
        List<Person> persons = FileHelper.getPersonsFromExcel(fileLocation, "Persons1");
        Assertions.assertNull(persons);
    }
